...
export const ui = {
  en: {
    // Site Metadata
    'siteMetadata.title': 'A blog by Guillaume C. Marty',
    'siteMetadata.headerTitle': 'A blog by Guillaume C. Marty',
    'siteMetadata.description':
      'A blog about JavaScript, HTML, the web platform, NLP and to how optimise them all!',
    ...
    'pages.apps.description': 'All apps',
    'pages.apps.allApps': 'Apps and video games',
    'pages.apps.showcase':
      'I am the creator and maintainer of apps and video games that you can install and play today!',
    'pages.talks.title': 'Talks',
    'pages.talks.description': 'Public speaking',
    ...
    'components.cards.publishedIn': 'Published in',
    ...
    'layouts.listWithTagsLayout.allPosts': 'All blog posts',
    // 'layouts.listWithTagsLayout.publishedAt': 'Published at',
    'layouts.listWithTagsLayout.publishedOn': 'Published on',
    // 'layouts.postLayout.publishedAt': 'Published at',
    'layouts.postLayout.publishedOn': 'Published on',
